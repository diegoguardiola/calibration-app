...
function UserList() {
    ...
    const columns = React.useMemo(
        () => [
            ...
            {
                Header: 'Email',
                accessor: 'email', // replace 'email' with the actual data field
            },
            {
                Header: 'Company',
                accessor: 'company', // replace 'email' with the actual data field
            },
            {
                Header: 'Role',
                accessor: 'role', // replace 'email' with the actual data field
            },
            {
                Header: 'Delete',
